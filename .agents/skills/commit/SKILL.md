---
name: commit
description: Prepare and create a focused git commit for the current uncommitted work. Use when the user asks to commit changes, create an atomic commit, or draft an appropriate commit message from the working tree.
---
